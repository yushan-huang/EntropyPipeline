...
evaluation_final = pd.concat([evaluation_final, F1_tr, F1_ts, recall_tr, recall_ts, acc_tr, acc_ts], axis=1)
...
evaluation_final.columns = ['F1_bs_tr','F1_bs_ts','recall_bs_tr','recall_bs_ts','acc_tr','acc_ts']
evaluation_final.to_csv('evaluation_entropy_MLP.csv')
...
#results
# epoch=4994, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
# epoch=4995, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
# epoch=4996, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
# epoch=4997, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
# epoch=4998, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
# epoch=4999, train:loss=0.035,recall=0.990,f1=0.662  dev:loss=0.036,recall=0.963,f1=0.650
